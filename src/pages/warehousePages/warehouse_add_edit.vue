		...
		<el-card class="box_card scroll_y">
			...
			<div class="card_content">
				<el-form size="small" label-width="150px">
					...
					<el-form-item>
						<el-input type="textarea" :rows="5" size="small" clearable v-model="introduction" placeholder="（必填）有了作品简历，大家对您的作品更感兴趣了"></el-input>
					</el-form-item>
					...
					<el-form-item label="插画分类：">
						<div class="cate_list">
							<div class="cate_item" :class="{'active_cate':item.is_checked == true}" v-for="(item,index) in cate_list" @click="checkCate(index)">{{item.cate_name}}</div>
						</div>
					</el-form-item>
					<el-form-item label="插画标签：">
						<div class="cate_list">
							...
							<el-input class="input-new-tag" v-if="is_input" v-model="input_value" ref="saveTagInput" size="small" @keyup.enter.native="handleInputConfirm" @blur="handleInputConfirm"
							></el-input>
					...
					<el-form-item label="上传图片：" required>
						<div class="cate_list">
							<div class="view_card_img" @mouseenter="item.show_icon = true" @mouseleave="item.show_icon = false" v-for="(item,index) in preview_images">
							...
							<UploadFile :is_multiple="true" :current_num="preview_images.length" :max_num="3" @callbackFn="callbackFn" v-if="preview_images.length < 3"/>
						</div>
					</el-form-item>
					<el-form-item>

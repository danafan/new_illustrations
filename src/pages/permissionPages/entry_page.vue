    ...
    <el-table size="small" :data="dataObj.data" tooltip-effect="dark" :header-cell-style="{'background':'#f4f4f4'}"
      ...
      <el-table-column label="操作" align="center" width="200" fixed="right">
        <template slot-scope="scope">
          <el-button class="button_theme" type="text" size="small" @click="accessSetting('2',scope.row.id)"
    ...
    <el-dialog :title="`${type == '1'?'添加':'编辑'}权限`" center width="50%" @close="closeDialog" :visible.sync="show_dialog"
      ...
      <el-form size="small" label-width="150px">
        ...
        <el-form-item label="是否按钮：">
          <el-switch v-model="is_button" :active-value="1" :inactive-value="0" active-color="#F36478" inactive-color="#778899">
          </el-switch>
        </el-form-item>

    ...
    <el-card class="box_card" id="box_card">
      <el-form :inline="true" size="mini" class="demo-form-inline" id="el_form">
        ...
        <el-form-item label="日期:">
          <el-date-picker v-model="dates" align="left" type="daterange" unlink-panels value-format="yyyy-MM-dd"
      ...
      <!-- 同意/拒绝/绑定sku -->
      <el-dialog :title="dialog_title" center width="30%" :visible.sync="show_dialog" :append-to-body='true'
        @close="input_value = ''">

...
const index_detail = resolve=>require(['@/pages/indexPages/index_detail'],resolve)
...
const warehouse_detail = resolve=>require(['@/pages/warehousePages/detail'],resolve)
